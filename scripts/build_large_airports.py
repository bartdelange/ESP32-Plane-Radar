...
# This fork's regional display data. Add ISO country codes here deliberately;
# worldwide large airports are always retained regardless of this setting.
LOCAL_COUNTRIES = {"NL"}
...
def build_dataset() -> tuple[
    ...
    for a in airports:
        ...
        local = (a.get("iso_country") or "").upper() in LOCAL_COUNTRIES
        if airport_type != "large_airport" and not (
            local and airport_type in {"medium_airport", "small_airport"}
        ):
            continue
