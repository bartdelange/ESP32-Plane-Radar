...
# Bounds include every Netherlands location at the widest radar preset, with
# useful overlap into neighbouring countries. Add future maintained regions
# here; the generator and portable lookup are not Netherlands-specific.
REGIONS = [
    {"name": "NL", "west": 1.0, "south": 48.5, "east": 9.5, "north": 55.8,
...
""", encoding="utf-8")
    ...
    for region, bits in generated:
        ...
        entries.append(
            f'  {{"{region["name"]}", {region["west"]}, {region["south"]}, '
            f'{region["east"]}, {region["north"]}, {region["width"]}, '
            f'{region["height"]}, {symbol}}},')
    OUT_CPP.write_text(
